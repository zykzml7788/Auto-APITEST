package com.djcps.zyk.com.api;

import com.alibaba.fastjson.JSON;
import com.djcps.api.beans.ApiDataBean;
...
import test.com.djcps.api.ApiTest;
import test.com.djcps.api.TestBase;
...
public class CRMApiTest extends TestBase { 
...
//						.toString(respEntity));
	...
	private HttpUriRequest parseHttpRequest(String url, String method, String param) throws UnsupportedEncodingException {
		...
		if ("post".equalsIgnoreCase(method) || "upload".equalsIgnoreCase(method)) {
			...
			postMethod.setEntity(new ByteArrayEntity(param.getBytes("UTF-8")));
